        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className="order-1 md:order-2 flex justify-center">
            <div className="relative">
              <div className="w-80 h-80 md:w-96 md:h-96 bg-white/20 rounded-full backdrop-blur-sm border border-white/30 flex items-center justify-center">
              ...
              {/* Floating elements */}
              <div className="absolute -top-4 -right-4 w-12 h-12 bg-brand-yellow rounded-full flex items-center justify-center shadow-glow">
